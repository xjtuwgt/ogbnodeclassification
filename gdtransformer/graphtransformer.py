...
import numpy as np
from gdtransformer.layernormalization import RMSLayerNorm as LayerNorm
...
class gtransformerlayer(nn.Module):
    ...
    def reset_parameters(self):
        ...
        nn.init.xavier_normal_(self.fc_head.weight.data, gain=1.414)
        nn.init.xavier_normal_(self.fc_tail.weight.data, gain=1.414)
        nn.init.xavier_normal_(self.fc_out.weight.data, gain=1.414)
